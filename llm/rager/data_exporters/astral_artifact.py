...
def elasticsearch(
    ...
    pipeline_uuid = kwargs.get('pipeline_uuid', 'example')
    print("index name:", index_name)
    print("pipeline_uuid:", pipeline_uuid)
    

    set_global_variable(pipeline_uuid, 'index_name', index_name)
    ...
    new_index_name = kwargs.get('index_name', 'bad__example')
